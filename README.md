...
Out of the 80 papers, I have one flagged as good. That is for tear proteome characterization not for a good quantitative study. There were no good quantitative studies, in my opinion. Are these all "bad" papers by some arbitrary definition? No. I think they are good faith papers where the best techniques that the authors could employ were used to study tears to the best of their abilities **at that time**. Most of these papers are not by top labs that specialized in proteomics. Quantitative proteomics methods have always been (and continue to be) very challenging. Most of these early methods had some merit but were beyond the proteomics expertise of most labs, except for the labs that developed the methods.

These papers (mostly) met the bar for publication **at that time**. Like so many things, the bar keeps changing. Many of these studies would not meet the standards for publication by today's standards. We have better instruments and methods that can process more biological replicates. What gets over today's bar are papers where the methods are considered reasonable **by today's standards**. Do not sit on data for too long, or your window for publication may close.

## What are the Lessons?

You have to be pretty old and have been hanging out in the lab for way too long to be able to pass judgement on papers from more than 10 years ago (let alone 20+ years ago). It may be difficult for younger proteomics researchers to get a sense of the back stories and contexts for older proteomics work. This is a time to go talk to the "old" folks (or post something on Twitter) to get some perspective. A bigger problem is how non-proteomics experts (like clinical ophthalmologists) might perceive this tear literature. How do those folks know that most of these papers are not very useful to read or cite?

Human tears are not one of the systems that has had much focus from the "big" labs over the years. However, I think it is probably representative of a lot of proteomics work that has been published over the years. A lot of work happens in smaller labs with non-experts trying to use proteomics in their studies. We need to figure out better ways to communicate how to do quantitative proteomics experiments for the masses. We need less focus on cutting edge proof of principle papers and more focus on the important concepts like study designs, proper replicate numbers, matching methods to samples, quality control, sanity checks, etc.
